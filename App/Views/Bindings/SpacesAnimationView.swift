...
/// A decorative explanation of how each window behavior changes Spaces.
///
/// The `TimelineView` is only active while this scene is foreground-active and
/// the user has not requested reduced motion. In either static state, the view
/// shows the completed result of the selected behavior instead.
